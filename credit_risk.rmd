...
summary(test)
names(data)
model <- glm(default ~ value_mortgage_win+value_nonmortgage_win+age+employed+full_time+
               annual_income_win+single+kids+car+sector, family = binomial(link = 'logit'), data = train)
summary(model)
```
